...
require (
	...
	github.com/palantir/conjure-go/v6 v6.50.0
	github.com/palantir/distgo v1.62.0
...
require (
	...
	github.com/palantir/witchcraft-go-error v1.30.0 // indirect
	github.com/palantir/witchcraft-go-params v1.28.0 // indirect
