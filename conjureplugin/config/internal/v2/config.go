...
type SingleConjureConfig struct {
	...
	// Extensions contains entries for the "extensions" block for IR that is generated by this configuration. Only
	// relevant if the configuration generates IR from YAML (is not applied if the IR is fetched rather than generated).
	//
	// If there are no assets related to extensions, this map is set directly as the value of the "extensions" field.
	// If there is a "conjure-ir-extensions-provider" asset, this map is set as the value of the "extensions" field when
	// the IR is generated and then, if the IR is published using the "publish" operation, the extensions map returned
	// from the "conjure-ir-extensions-provider" asset is set/merged on top of it.
