...
type ConjurePluginConfig struct {
	...
	// If not specified, defaults to false (conflicts cause errors).
...
type SingleConjureConfig struct {
	// OutputDir is the base output directory. If not specified, defaults to "internal/generated/conjure".
	// The final output location will be {OutputDir}/{ProjectName}/ unless OmitTopLevelProjectDir is true.
	...
	// OmitTopLevelProjectDir skips creating the {ProjectName} subdirectory when true.
	// If not specified, defaults to false (project name subdirectory is created).
	OmitTopLevelProjectDir *bool `yaml:"omit-top-level-project-dir,omitempty"`
	// SkipDeleteGeneratedFiles skips cleanup of old generated files when true.
	// If not specified, defaults to false (cleanup is performed).
