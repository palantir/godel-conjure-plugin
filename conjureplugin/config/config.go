...
const (
	LocatorTypeAuto   = LocatorType(v2.LocatorTypeAuto)
	LocatorTypeRemote = LocatorType(v2.LocatorTypeRemote)
	LocatorTypeYAML   = LocatorType(v2.LocatorTypeYAML)
	LocatorTypeIRFile = LocatorType(v2.LocatorTypeIRFile)
)
